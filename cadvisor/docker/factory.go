...
var DockerFactory *dockerFactory = nil

var ArgDockerEndpoint = flag.String("docker_fake", "unix:///var/run/docker.sock", "docker endpoint")
...
var dockerEnvWhitelist = flag.String("docker_env_metadata_whitelist_fake", "", "a comma-separated list of environment variable keys that needs to be collected for docker containers")

var (
	// Basepath to all container specific information that libcontainer stores.
	dockerRootDir string

	dockerRootDirFlag = flag.String("docker_root_fake", "/var/lib/docker", "DEPRECATED: docker root is read from docker info (this is a fallback, default: /var/lib/docker)")
...
func Register(factory info.MachineInfoFactory, fsInfo fs.FsInfo, ignoreMetrics container.MetricSet) (*dockerFactory, error) {
	client, err := Client()
	if err != nil {
